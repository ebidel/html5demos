...
function getCurSlideFromHash() {
  ...
  var slideNo = parseInt(location.search.substr(1));
...
function handleDomLoaded() {
  ...
  var wrapup = document.querySelector('#wrapup ol');
  var cans = document.querySelectorAll('article.can h1');
  ...
  slides.addEventListener('slideenter', function(e) {
    var slide = e.target;
  ...
  slides.addEventListener('slideleave', function(e) {
    var slide = e.target;
    if (slide.dataset.bodyClass) {
  ...
  var watchID = window.navigator.geolocation.watchPosition(function(position) {
    ...
    var url = '//maps.google.com/maps/api/staticmap?center=' + lat + ',' + lon +
              '&zoom=12&size=896x120&scale=2&maptype=roadmap' +
